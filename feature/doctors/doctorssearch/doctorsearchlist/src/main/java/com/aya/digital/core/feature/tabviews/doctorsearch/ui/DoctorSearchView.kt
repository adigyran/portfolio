...
class DoctorSearchView :
    DiFragment<ViewDoctorsearchListBinding, DoctorSearchViewModel, DoctorSearchState, DoctorSearchSideEffects, DoctorSearchUiModel, DoctorSearchStateTransformer>() {
