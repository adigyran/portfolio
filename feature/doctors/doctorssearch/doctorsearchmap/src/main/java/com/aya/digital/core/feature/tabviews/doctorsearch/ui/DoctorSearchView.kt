...
class DoctorSearchView :
    DiFragment<ViewDoctorsearchMapBinding, DoctorSearchViewModel, DoctorSearchState, DoctorSearchSideEffects, DoctorSearchUiModel, DoctorSearchStateTransformer>() {
