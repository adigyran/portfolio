...
fun profileInsuranceAddDiModule(
    ...
    bind {
        scoped(CustomFragmentScope).singleton {
            ProfileInsuranceAddViewModel(param, parentCoordinatorEvent,instance("parent_coordinator_bottomnav"), instance(),instance(), instance(),instance(),instance(),instance(),instance())
        }
    }
}