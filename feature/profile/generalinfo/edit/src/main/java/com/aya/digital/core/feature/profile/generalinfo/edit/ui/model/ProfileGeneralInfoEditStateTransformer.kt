        ...
        ProfileGeneralInfoEditUiModel(
            data = kotlin.run {
               return@run mutableListOf<DiffItem>().apply {
                   add(NameFieldUIModel(FieldsTags.FIRST_NAME_FIELD_TAG,"First Name",state.firstName.getField(),null))
                   add(NameFieldUIModel(FieldsTags.LAST_NAME_FIELD_TAG,"Last Name",state.lastName.getField(),null))
                   add(NameFieldUIModel(FieldsTags.MIDDLE_NAME_FIELD_TAG,"Middle Name",state.middleName.getField(),null))
                   add(SelectionFieldUIModel(FieldsTags.BIRTH_DATE_FIELD_TAG,"Date of Birth",state.birthDate.getField(),null))
                   add(DropdownFieldUIModel(FieldsTags.SEX_FIELD_TAG,getSexesList(),"Sex","",null))
                   add(NameFieldUIModel(FieldsTags.HEIGHT_FIELD_TAG,"Height",state.height.getField(),null))
                   add(NameFieldUIModel(FieldsTags.WEIGHT_FIELD_TAG,"Weight",state.height.getField(),null))
                   add(NameFieldUIModel(FieldsTags.SHORT_ADDRESS_FIELD_TAG,"Short Address",state.shortAddress.getField(),null))
               }
            }
        )
