...
internal class SaveInsuranceUseCaseImpl(private val profileInsuranceRepository: ProfileInsuranceRepository,
                                        private val progressRepository: ProgressRepository
) : SaveInsuranceUseCase {
    override fun invoke(saveModel: InsuranceSaveModel): Single<RequestResultModel<Boolean>> =
        profileInsuranceRepository.saveInsurance(saveModel.id, InsurancePolicyBody(saveModel.number,saveModel.name,saveModel.photo))
