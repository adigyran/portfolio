...
internal class GetDoctorInsurancesUseCaseImpl(private val practitionerRepository: PractitionerRepository,
                                              private val progressRepository: ProgressRepository
) : GetDoctorInsurancesUseCase {
    override fun invoke(): Observable<RequestResultModel<List<Int>>> =
        practitionerRepository.getPractitionerInsurances()
