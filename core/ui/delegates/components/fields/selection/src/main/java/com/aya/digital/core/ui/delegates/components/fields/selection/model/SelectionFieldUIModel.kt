...
class SelectionFieldUIModel(val tag:Int,label: String, text: String?, error: String?) : FieldItem(label, text,
    error
) {
    ...
    override fun areContentsTheSame(newItem: DiffItem): Boolean =
        super.areContentsTheSame(newItem) && newItem is SelectionFieldUIModel && this.tag == newItem.tag
}