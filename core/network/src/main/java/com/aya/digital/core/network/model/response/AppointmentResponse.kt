...
data class AppointmentResponse(
    ...
    @Json(name = "refPatient") val patient: PatientResponse?,
    @Json(name = "refPractitioner") val practitioner: PractitionerResponse?,
    @Json(name = "refSlot") val slot: SlotResponse?,
)
