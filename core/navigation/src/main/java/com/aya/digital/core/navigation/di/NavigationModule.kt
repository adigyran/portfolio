...
import com.aya.digital.core.navigation.manager.PatientAppNavigationManager
import com.aya.digital.core.navigation.manager.PatientAppNavigationManagerImpl
...
fun navigationDiModule() = DI.Module("navigationDiModule") {
    ...
    bind<PatientAppNavigationManager>() with eagerSingleton { PatientAppNavigationManagerImpl() }
